    ...
    (function ()
    {
        ...
        function parse(str)
        {
            ...
            function parseObject(snatch)
            {
                function parsePair(snatch)
                {
                    function parseString(snatch)
                    {
                        ...
                        if (firstChar === '"')
                        {
                            ...
                            return snatch.update('<span class="property">"<span class="p" data-property-name="' + name.substring(1, name.length - 1) + '">' + name.substring(1, name.length - 1) + '</span>"</span>')
                        }
                ...
                {
                    snatch.shift(1);
                    snatch.update('<span class="object collapsed"><span class="toggle">{</span><ul>');
            ...
            function parseArray(snatch)
            {
                ...
                snatch.shift(1);
                snatch.update('<span class="array collapsed">');
        ...
        function analyze()
        {
            ...
            setTimeout(function ()
            {
                ...
                // handle jsonrpc
                $('.object:first').find('.toggle:first').click();
